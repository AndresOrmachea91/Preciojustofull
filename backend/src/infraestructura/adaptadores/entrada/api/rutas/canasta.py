...
from src.infraestructura.adaptadores.entrada.api.dependencias import caso_calcular_canasta
from src.infraestructura.adaptadores.entrada.api.mapeo import canasta_a_salida
